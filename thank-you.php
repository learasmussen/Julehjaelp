...
<div class="text-center my-4 d-none d-md-flex justify-content-center align-items-center">
    <a href="#" class="btn btn-yellow fw-bold d-flex align-items-center p-0 justify-content-center thank-you-button-text" style="height: 40px; width: 150px;">
        Giv en gave
    </a>
    <a class="btn fw-bold text-decoration-underline thank-you-button-text" href="#">Tilbage til forsiden</a>
</div>
