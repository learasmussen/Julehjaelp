...
<div class="container-fluid px-3 px-md-0 mx-md-0">
    ...
    <p class="text-center h4 mb-5 mx-md-5 instrument donate-an-amount-text">Her kan du læse mere om Julehjælp &
        Ønskehuen</p>
    ...
    <div class="d-flex flex-column flex-md-row mb-4 px-md-3 px-lg-5">
        ...
        <div class="col-md-6 bg-darkgreen text-white p-4 rounded-5 flex-fill mb-3 mb-md-0 mx-md-2">
            ...
            <p class="mb-0 info-middle-text py-3 instrument">Julehjælp er støtte til udsatte familier, så deres børn kan
                få en tryg og værdig jul.</p>
        ...
        <div class="text-center d-md-none my-3 pb-3">
            <a href="payment.php" class="btn btn-yellow fw-bold px-4 py-2 doner-et-beløb-knap roboto">DONER ET VALGFRIT
                BELØB</a>
        </div>
        ...
        <div class="col-md-6 bg-darkgreen text-white p-4 rounded-5 flex-fill mx-md-2 ">
            ...
            <p class="mb-0 info-middle-text py-3 instrument">En digital Ønskehue med ønsker fra danske børn i
                krisecentre og lignende.</p>
